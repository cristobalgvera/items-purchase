...
import { ValidateUserLocationSpreadsheetService } from "@features/shared/adapters/validate-user-location-spreadsheet.service";
...
const validateUserLocationService: ValidateUserLocationService =
  new ValidateUserLocationSpreadsheetService(purchasedOrdersSheet, activeSheet);
